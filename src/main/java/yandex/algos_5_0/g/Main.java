...
//        if (myTeam <= reinforcement && barack > myTeam) {
//            return -1;
//        }
...
//        }
        ...
        if (barack[0] != 0) {
//            if (myTeam > opponentTeam[0]) { //сражение продолжается
...
//                barack[0] -= Math.max(myTeam, 0);
//                barack[0] = myTeam >= barack[0] ? 0 : barack[0] - myTeam;
//                opponentTeam[0] = ;
//                return 0;
            }
...
//                return -1;
//            }
//            if (myTeam > opponentTeam[0] - myTeam) {
//
//            }
//
//            if (myTeam == opponentTeam[0]) {
//
//            }
        } else {
