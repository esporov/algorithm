...
public class Main {
    ...
    public static Map<String, Integer> monthOrderMap = new HashMap<>() {{
        ...
        put("June", 5);//Saturday
        put("July", 6);//Sunday
        put("September", 7);//Sunday
        put("October", 8);//Sunday
        put("November", 9);//Sunday
        put("December", 10);//Sunday
    }};
...
//        };
        ...
        //366 в високосный | 365 в обычный
...
//                curDayOfWeek = 0;
//            }
            if (curDayOfWeek == 6) { //каждый вс добавляем (но он не рабочий может и не стоит)
//                dayWeekArray[6] += 1;
                continue;
            }
        ...
        int indexBad = 0;
        int indexGood = 0;
        for (int i = 0; i < dayWeekArray.length - 1; i++) {
